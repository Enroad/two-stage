...
class DALETrain(Dataset):
    def __init__(self, root_dir, args):
        ...
        Arguments:
            ...
            2) arguments -> args
        """
        self.low_light_dir = root_dir + 'train_lowimage_SLIC'
        self.ground_truth_dir = root_dir + 'train_lowimage'
        self.low_light_img_list = os.listdir(root_dir + 'train_lowimage_SLIC')
        self.ground_truth_img_list = os.listdir(root_dir + 'train_lowimage')
